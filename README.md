...
Out-of-scope redirect warnings show the request role and actual redirect status, for example `[Normal] Got Redirect 302: URL`. The resolved destination URI is white and italicized when terminal styling is enabled and plain otherwise.
